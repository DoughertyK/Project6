...
class Reader { // uses package-private for SOLID -- limited access to this class
     ...
     * @return Array of integers to be sorted and made into linked list using SortList class, only returns valid integers.
     */
    private Integer[] inputToArray(String[] input) {
        ...
        for (int i = 0; i < input.length; i++) {
            try { // try-catch handles exceptons for non-integers
                ...
                System.out.println(input[i] + " cannot be added to linked list. Skipping this value.");
                System.out.println("-------------------------");
            }
        }
